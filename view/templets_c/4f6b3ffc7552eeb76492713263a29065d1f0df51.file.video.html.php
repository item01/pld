<?php /* Smarty version Smarty-3.1.18, created on 2015-10-20 10:44:42
         compiled from "D:\boai\view\templets\home\index\video.html" */ ?>
<?php /*%%SmartyHeaderCode:212945625a5087888b8-85486673%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4f6b3ffc7552eeb76492713263a29065d1f0df51' => 
    array (
      0 => 'D:\\boai\\view\\templets\\home\\index\\video.html',
      1 => 1445309077,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '212945625a5087888b8-85486673',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_5625a5088440e5_17843423',
  'variables' => 
  array (
    'templets' => 0,
    'type_list' => 0,
...
<?php if ($_valid && !is_callable('content_5625a5088440e5_17843423')) {function content_5625a5088440e5_17843423($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("common_head.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
<div class="mainbox">
    <div class="main">
        <ul class="mainone">
            <li>您现在的位置:<a class="one" href="/index.php/home/index/index">首页</a>&nbsp;>&nbsp;<a class="two" href="/index.php/home/index/news/id/15/tid/3">新闻动态</a>&nbsp;>&nbsp;<span>视频专区</span></li>
        </ul>
        <ul class="maintwo">
            <li class="left"> 
...
?>
                <div <?php if ($_smarty_tpl->tpl_vars['id']->value==$_smarty_tpl->tpl_vars['type_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['v']['index']]['id']) {?> class="current1"<?php }?>><a href="/index.php/home/index/<?php echo $_smarty_tpl->tpl_vars['type_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['v']['index']]['n_link'];?>
/id/<?php echo $_smarty_tpl->tpl_vars['type_list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['v']['index']]['id'];?>
...
?>
                <dl>
                    <dd><h2><a href="<?php echo $_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['v']['index']]['url'];?>
"><?php echo $_smarty_tpl->tpl_vars['list']->value[$_smarty_tpl->getVariable('smarty')->value['section']['v']['index']]['v_title'];?>
