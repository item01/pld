<?php
    ...
    class WxApi {
        const appId         = "wx951c440b70e14314";
        const appSecret     = "08c10f914f18060e7fa9dbb2172eb0e0";
        ...
        public function wxAccessToken($appId = NULL , $appSecret = NULL){
                ...
                if( !is_array($token_array) || !isset($token_array['get_token_time']) ){
                    ...
                    if( $now_time - $token_array['get_token_time'] >6000 ){
                        $token_array = $this->wxAccessToken2();
                       //  echo $now_time  ;exit;
                    }
                }
   ...
   public function file_get_weixin_token($now_time=""){
    ...
    public function weixin_token_file(){
        return ROOT_PATH.'/data/get_token.txt';
    }
    public function weixin_jsapi_ticket(){
        return ROOT_PATH.'/data/jsapi_ticket.json';
    }
